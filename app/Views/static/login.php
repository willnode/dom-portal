...
<body class="text-center" style="background: url(https://images.unsplash.com/photo-1520995075477-7fddc4fc8cd6?ixlib=rb-1.2.1&auto=format&fit=crop&w=1953&q=80) center/cover #004494; position: relative">
	<div class="justify-content-center container d-flex flex-column" style="min-height: 100vh; max-width: 476px">
		...
		<form method="POST" name="loginForm" class="container shadow d-flex flex-column justify-content-center pb-1 pt-3 text-white">
			...
			<div class="separator mb-3"><?= lang('Interface.or') ?></div>
			<fieldset class="signin-group mb-2">
				...
				<a href="<?= href('register' . ($r ? '?r=' . $r : '')) ?>" class="btn d-flex align-items-center btn-light border-secondary mb-2">
					<span class="mx-auto"><?= lang('Interface.registerWithEmail') ?></span>
				</a>
				<button type="button" id="google-signin2" class="btn d-flex align-items-center btn-light  border-secondary">
					...
					<span class="mx-auto"><?= lang('Interface.signInWith') ?> Google</span>
				</button>
				<button type="button" id="github-signin2" onclick="location = '/api/signin/github/'" class="btn d-flex align-items-center btn-light  border-secondary">
					...
					<span class="mx-auto"><?= lang('Interface.signInWith') ?> GitHub</span>
				</button>
		...
		<div class="floating">
			<small>
				<a href="https://unsplash.com/photos/eklcTOJExBA" target="_blank" rel="noopener noreferrer">Background by Frank Marcheski</a>
			</small>
		</div>
	</div>
	<script>
