      ...
      <div class="row">
        <div class="col-md-6 col-xl-3">
          <div class="card-body d-flex flex-column h-100">
            ...
            <p><small><a href="https://<?= $slave ?>.domcloud.id:8443/" target="_blank" rel="noreferrer">Login ke Portal</a></small></p>
            <p><small><a href="/user/hosting/login/<?= $id ?>">Panduan Login ke Portal</a></small></p>
          </div>
        </div>
        <div class="col-md-6 col-xl-3">
          <div class="card-body d-flex flex-column h-100">
